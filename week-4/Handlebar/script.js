...
/* ------------------------------------------------------------------
                Example 2: Handlebars: data one Object 
--------------------------------------------------------------------- */
//Here we are going to generate/create our new HTML.
//The data that we pass has to be an Object
// var characterHtml = Handlebars.templates.characterTemplate(character);

// var characterSection = document.getElementById("character-section");
// characterSection.innerHTML = characterHtml;

/* ------------------------------------------------------------------
                Example 3: Handlebars: Data Array
--------------------------------------------------------------------- */
